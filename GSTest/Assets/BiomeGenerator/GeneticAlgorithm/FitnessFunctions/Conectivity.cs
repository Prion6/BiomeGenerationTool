...
public class Conectivity : BaseFitnessFunction
{
    ...
    public override double Evaluate(IChromosome chromosome)
    {
        ...
        foreach(Tuple<int,int> t in MapWindow.StartPoints)
        {
            ...
            breaks++;
            val += FloodFIll.NodeCount(t, (chromosome as LayerChromosome).ToFloatingPoints(), (chromosome as LayerChromosome).N, Closed,0,0);
        }

        return val/breaks*chromosome.Length*1.0f;
    }
